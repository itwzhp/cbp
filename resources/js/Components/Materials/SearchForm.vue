...
<template>
  <form @submit.prevent="submit" class="pb-3">
    ...
    <div class="relative">
      ...
      <input minlength="3" type="search" id="default-search" :disabled="store.getLoading" v-model="form.search"
      ...
      <button type="submit"
        class="text-white absolute right-2.5 bottom-2.5 bg-cbp-100 hover:bg-cbp-200 focus:ring-2 focus:outline-none focus:ring-cbp-100 font-medium rounded-lg text-sm px-4 py-2">Szukaj</button>
    </div>
  </form>
</template>
