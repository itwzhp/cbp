...
const searchSubmit = (search) =>
  store.getData(search, store.getTagIds).then(() => redirect());
      ...
      <div class="fixed inset-0">
        <div class="absolute inset-0">
          <div class="pointer-events-none fixed inset-y-0 flex max-w-full">
            ...
            >
              <DialogPanel
                class="pointer-events-auto relative w-screen max-w-md overflow-auto bg-white"
              >
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    ...
                    <div>
                      ...
                      >
                        <Taxonomy
                          :item="item"
                          :default-ids="store.getTagIds"
                          @tag-selected="tagSelected($event)"
                          @tag-removed="tagRemoved($event)"
                        />
                      </template>
                    </div>
                  </div>
