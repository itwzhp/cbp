...
<template>
  <div v-if="authors.length || reviewers.length || redactors.length">
    ...
    <template v-if="authors.length">
      ...
      <div v-for="(author, key) in authors" :key="key" class="grid grid-cols-4 gap-1 place-items-center mt-5 mb-5">
    ...
    <template v-if="redactors.length">
      ...
      <div v-for="(redactor, key) in redactors" :key="key" class="grid grid-cols-4 gap-1 place-items-center mt-5 mb-5">
          <div class="col-span-1">
              <Avatar />
          </div>
          <div class="col-span-3 w-full">
    ...
    <template v-if="reviewers.length">
      ...
      <div v-for="(reviewer, key) in reviewers" :key="key" class="grid grid-cols-4 gap-1 place-items-center mt-5 mb-5">
          <div class="col-span-1">
              <Avatar />
          </div>
          <div class="col-span-3 w-full">
