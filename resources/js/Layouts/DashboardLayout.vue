...
<template>
    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button @click="toggleMobileSidebar()" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
        ...
        <div class="flex items-center">
          <div class="flex items-center ml-3">
            <div @click="toggleUserDropdown()" class="hidden sm:flex items-center space-x-4 cursor-pointer">
            ...
            <div :class="{ hidden: userDropdownHidden }"
              style="width: 190px; position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(calc(100vw - 190px), 82px);"
  ...
  <aside id="logo-sidebar"
    ...
    :class="{ 'translate-x-0': !mobileSidebarHidden }" aria-label="Sidebar">
